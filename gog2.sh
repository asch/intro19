Write dash script which will write it own code to your personal web page on Matfyz http://www.ms.mff.cuni.cz/~USERNAME/intro19.html
write your USERNAME which you use for login in lab or SIS
You must set up your web page firts, this may help you http://wiki.ms.mff.cuni.cz/wiki/laborato%C5%99_UNIX#WWW_str%C3%A1nky
